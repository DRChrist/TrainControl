...
//  {
//    checksum = checksum ^ msg[1].data[i]; //needs testing
//  }
  checksum = trainAddress ^ trainAddress2 ^ data; //maybe not the best way of doing it
  if(msg[1].len == 3)
  {
  ...
  else
  {
    noInterrupts();
    msg[1].data[0] = trainAddress;
    msg[1].data[1] = trainAddress2; //needs testing
    msg[1].data[2] = data;
...
{
  trainAddress2 = 0; //to make sure checksum calculations work.
  if(adr == '1')
  {
